  ...
  <div class="xtx-pay-page">
    <div class="container">
      ...
      <div class="pay-result">
        <span class="iconfont icon-queren2 green" v-if="$route.query.payResult==='true'"><p class="tit">支付成功</p></span>
        <span class="iconfont icon-shanchu red" v-else><p class="tit">支付失败</p></span>
